const canciones = [
    ...
    "Double You - Run to me.mp3",
    "Haddaway - What Is Love.mp3",
    "Better Off Alone.mp3",
    "La Bouche - Be My Lover.mp3",
    "Ice MC - Its a Rainy Day.mp3",
    "Dreams.mp3"
    ]
    var indiceActual = new Array(1)
    //Funcion para crear el listado de canciones
    ...
    function loadMusic(ruta){
        ...
        var folder ="music";//Carpeta donde tenemos almancenada la musica
